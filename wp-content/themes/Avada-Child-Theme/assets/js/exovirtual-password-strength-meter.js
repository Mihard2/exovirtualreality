...
( function( $ ) {
    ...
    var wc_password_strength_meter = {
        ...
        checkPasswordStrength: function( wrapper, field ) {
            ...
            if (!wc_password_strength_meter.existLowerSymbol(field.val())){
                strength=1;
                error = ' - ' + wc_password_strength_meter_params.i18n_password_error;
            }else{
                LowCheck=true;
            ...
            if (!wc_password_strength_meter.existUpperSymbol(field.val())){
                strength=1;
                error = ' - ' + wc_password_strength_meter_params.i18n_password_error;
            }else{
                UpCheck=true;
            ...
            if (!wc_password_strength_meter.existNumberSymbol(field.val())){
                strength=1;
                error = ' - ' + wc_password_strength_meter_params.i18n_password_error;
            }else{
                NumbCheck=true
            ...
            if (lenCheck && LowCheck && UpCheck && NumbCheck) strength=2;
        ...
        existUpperSymbol:function(val){
            return (/[A-Z]/.test(val));
        },
        existLowerSymbol:function(val){
            return (/[a-z]/.test(val));
        },
        existNumberSymbol:function(val){
            return (/[0-9]/.test(val));
        }
    };
